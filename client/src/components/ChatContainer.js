...
import { db } from "./firebaseConfig/firebaseConfig.js"; // Import db from firebaseConfig.js
...
export default function ChatContainer() {
    ...
    const chatsRef = collection(db, "Messages"); // Initialize chatsRef using db from firebaseConfig.js
